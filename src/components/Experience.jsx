    ...
    return [
      {
        ...
        subtitle: `ُ لم تتوقف أحالمنا منذ بدأت دولتا، وسنعمل
        على تـحقيقها ما حيينا.`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        title: "ذا لاين",
        subtitle: ` مدينة تخلو من التلوث والحوادث المرورية`,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
        ...
        subtitle: ` تشجيع السكان على اتباع أنماط صحية في التنقل، والتحفيز على ممارسة الرياضات المختلفة وبشكل خاص المشي وركوب الدراجات والخيول، `,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        title: " المكعب",
        subtitle: `رفع مستوى جودة الحياة وتطبيق معايير الاستدامة، وذلك من خلال توفير المساحات الخضراء وتعزيز المفاهيم الرياضية والصحية والمجتمعية`,
      },
    ];
  }, []);
